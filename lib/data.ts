...
export const skills = {
  ...
  tools: ["Git", "Docker", "VS Code", "Postman", "Cloudinary", "Vercel"],
...
export const projects = [
  ...
  {
    id: 4,
    title: "Interactive CV Website - Frontend Developer",
    description: "A animated CV built with Next.js, TypeScript, and Framer Motion to showcase development skills.",
    technologies: ["Next.js", "TypeScript", "Tailwind CSS", "Framer Motion"],
    image: "/images/cv-website.png",
    video: "/vidoes/cv-website.mp4",
    liveUrl: "https://cv-website-navy.vercel.app/",
    githubUrl: "https://github.com/NatanelRichey/cv-website",
    highlights: [
      "TypeScript end-to-end type safety. Next.js App Router with Server Components",
      "Framer Motion scroll animations. Theme system with localStorage persistence",
    ],
    category: "Frontend",
  },
  {
    ...
    longDescription: "Automated WhatsApp data collection tool with integrated API-based AI sentiment analysis to extract insights from conversations.",
    technologies: ["OpenAI API", "Web Scraping", "Data Analysis"],
